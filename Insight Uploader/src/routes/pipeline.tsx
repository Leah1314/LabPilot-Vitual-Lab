...
export const Route = createFileRoute("/pipeline")({
  head: () => ({
    meta: [
      { title: "Pipeline — Pathogen AI" },
      { name: "description", content: "End-to-end pipeline from BV-BRC ingest to interactive dashboard." },
      { property: "og:title", content: "Pipeline — Pathogen AI" },
      { property: "og:description", content: "End-to-end pipeline from BV-BRC ingest to interactive dashboard." },
    ],
  }),
