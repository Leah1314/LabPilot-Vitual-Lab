  ...
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Choose data source — Pathogen AI" },
      {
        ...
        content: "Upload files, connect an external API, or use the built-in sample dataset to start pathogen AMR analysis.",
      },
    ],
  }),
...
app.add_middleware(
    ...
    allow_headers=["*"],
              ...
              <p className="mt-2 text-muted-foreground">
                For local development, adding <code className="font-mono">http://localhost:5173</code> (or your
