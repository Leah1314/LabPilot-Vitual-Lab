...
export const Route = createFileRoute("/insights")({
  head: () => ({
    meta: [
      { title: "AI Insights — Pathogen AI" },
      { name: "description", content: "Grounded AI-generated insights across pathogen clusters." },
      { property: "og:title", content: "AI Insights — Pathogen AI" },
      { property: "og:description", content: "Grounded AI-generated insights across pathogen clusters." },
    ],
  }),
  component: Insights,
});
