...
export function LabPilotDashboard() {
  ...
  const simulate = (event: FormEvent) => { event.preventDefault(); const value = Number(dose); if (Number.isFinite(value) && value >= 1 && value <= 100) { setPrediction(predictViability(value)); setPlanStatus("idle"); } };
